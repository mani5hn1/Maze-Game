...
namespace Maze_Game
{
    ...
    {
        //This is Room 3 screen where the boarders are very thick and difficult to play through.
        ...
        private void SubmitScoreButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string query = string.Format("Insert [MazeGame] ([Username], [Time], [CoinsCollected], [Room], [Collisions]) values ('{0}','{1}',N'{2}', '{3}', '{4}')", LoginScreen.Username, string.Format("{00}", sw.Elapsed.Seconds + " seconds"), collection, "Room 3", collision);
